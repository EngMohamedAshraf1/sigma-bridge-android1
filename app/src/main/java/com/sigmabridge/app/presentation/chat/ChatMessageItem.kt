...
fun ChatMessageItem(
    ...
    val background = if (isMine) MaterialTheme.colorScheme.primaryContainer else MaterialTheme.colorScheme.surfaceVariant
    ...
    Row(
        ...
        Column(
                ...
                Column(
                    ...
                    Row(
                        ...
                        if (isMine) {
                            ...
                            Text(receiptText, style = MaterialTheme.typography.labelSmall, color = receiptColor)
                        }
                    }
                }
            }
            ...
            if (grouped.isNotEmpty()) {
                LazyRow(modifier = Modifier.padding(top = 2.dp), horizontalArrangement = Arrangement.spacedBy(4.dp)) {
