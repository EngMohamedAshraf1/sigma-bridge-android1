...
class GetChatLanguageUseCase @Inject constructor(
    private val languagePreferencesRepository: LanguagePreferencesRepository
) {
    suspend operator fun invoke(chatId: Long): LanguageConfiguration = languagePreferencesRepository.getChat(chatId)
}
